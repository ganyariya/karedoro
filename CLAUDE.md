...
### Warning System - ENHANCED FOR MAXIMUM ENFORCEMENT ✅
- Triggers every 5 minutes when idle in fullscreen overlay ✅
- Shows FORCEFUL system notification: "WARNING! You haven't started your next session! FOLLOW THE POMODORO TECHNIQUE!" ✅
- Plays AGGRESSIVE warning sound sequence (5 high-low beep cycles) ✅
- Continues relentlessly until user starts next session ✅
- Visual overlay uses RED background with YELLOW warning boxes ✅
- Cannot be ignored or dismissed easily ✅
...
## Design Requirements - ENFORCEMENT FOCUSED ✅

- Minimalist design with MAXIMUM VISUAL IMPACT for enforcement ✅
- No gamification features - PURE DISCIPLINE ✅
- No detailed statistics - FOCUS ON COMPLIANCE ✅
- Core Pomodoro functionality with AGGRESSIVE ENFORCEMENT ✅
- Visual feedback uses HIGH CONTRAST colors (red, yellow, white) ✅
- Audio feedback is UNAVOIDABLE and PERSISTENT ✅
- System notifications are CAPITALIZED and DEMANDING ✅
