...
// WorkingEbitenUIApp は動作するebitenuiアプリケーション
type WorkingEbitenUIApp struct {
	ui             *ebitenui.UI
...
// NewWorkingEbitenUIApp は新しいebitenuiアプリケーションを作成
func NewWorkingEbitenUIApp(services *application.Services) *WorkingEbitenUIApp {
	app := &WorkingEbitenUIApp{
...
func (a *WorkingEbitenUIApp) buildUI() {
	// ルートコンテナ
...
func (a *WorkingEbitenUIApp) setupInitialButtons() {
...
func (a *WorkingEbitenUIApp) createButton(buttonText string, clickHandler func()) *widget.Button {
	// 明確な色でボタンを作成
...
func (a *WorkingEbitenUIApp) updateButtons() {
...
func (a *WorkingEbitenUIApp) updateProgressBar() {
	session := a.sessionService.GetSession()
	sessionState := session.GetState()
...
func (a *WorkingEbitenUIApp) Update() error {
	a.ui.Update()
...
func (a *WorkingEbitenUIApp) Draw(screen *ebiten.Image) {
	// 背景を暗い色で塗りつぶし
...
func (a *WorkingEbitenUIApp) drawOverlayText(screen *ebiten.Image) {
	session := a.sessionService.GetSession()
	remaining := session.GetTimeRemaining()
...
func (a *WorkingEbitenUIApp) Layout(outsideWidth, outsideHeight int) (screenWidth, screenHeight int) {
